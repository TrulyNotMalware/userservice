...
import com.cotae.platform.userservice.aggregate.auth.configurations.filters.LoginAuthenticationFilter;
...
//                    .addHeaderWriter(new XFrameOptionsHeaderWriter(XFrameOptionsHeaderWriter.XFrameOptionsMode.SAMEORIGIN))
    ...
    public LoginAuthenticationFilter authenticationFilter(AuthenticationManager authenticationManager){
        ...
        loginAuthenticationFilter.setFilterProcessesUrl("/api/auth/login"); //Login Request Routes
